...
def preprocess(src_list: List[str]):
    ...
    tokenizer = tokenization.FullTokenizer(
        vocab_file='../../data/dicts/chinese_vocab.txt',
        do_lower_case=False,
    )
#/home/shared/models/bart-large-chinese-1/vocab.txt
#../../data/dicts/chinese_vocab.txt'
...
token_list,ids =preprocess(inp)
for line ,id in zip(token_list,ids):
    id_out.write(str(id)+'\n')
    out.write(line+'\n')
