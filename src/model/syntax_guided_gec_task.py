...
def load_langpair_dataset(
    ...
    for k in itertools.count():
        ...
        tag_dataset =data_utils.load_indexed_dataset(
            prefix+ 'tag', tgt_dict, 'mmap'
        )
        pinyin_dataset = None
        pinyin_dataset =data_utils.load_indexed_dataset(
            prefix+ 'pinyin', tgt_dict, 'mmap'
        )
...
class SyntaxEnhancedTranslationTask(TranslationTask):
    ...
    def build_dataset_for_pinyin_inference(self, src_tokens, src_lengths, pinyin,src_nt=None, src_nt_sizes=None, src_conll_dataset=None, src_dpd_dataset=None, src_probs_dataset=None, constraints=None, syntax_type=None):
        return SyntaxEnhancedLanguagePairDataset(
            src_tokens,
            src_lengths,
            self.source_dictionary,
